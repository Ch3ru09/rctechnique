          ...
          {faqs.map((faq, i) => {
            ...
            return (
              ...
              >
                ...
                <div className={`border-l-2 border-purple-600 overflow-hidden max-h-0 duration-[250ms] transition-all ease-in-out`} ref={setAnsRef} style={{ "max-height": opened ? `${ansRef?.scrollHeight}px` : "0px" } as CSSProperties}>
